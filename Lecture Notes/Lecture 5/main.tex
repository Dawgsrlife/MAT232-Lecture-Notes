...
\addcontentsline{toc}{subsubsection}{The \( xy \)-Plane (\( z = 0 \))}
...
\begin{conceptbox}
    ...
    \begin{blankbox}
        \subsubsection*{The \( yz \)-Plane (\( x = 0 \))}
            \addcontentsline{toc}{subsubsection}{The \( yz \)-Plane (\( x = 0 \))}
    ...
    \begin{blankbox}
        \subsubsection*{The \( xz \)-Plane (\( y = 0 \))}
            \addcontentsline{toc}{subsubsection}{The \( xz \)-Plane (\( y = 0 \))}
        \begin{minipage}{0.4\textwidth}
...
\addcontentsline{toc}{subsection}{Transitioning from 2D to 3D}
...
\addcontentsline{toc}{subsubsection}{Visualizing a Line in 3D}
...
\addcontentsline{toc}{subsubsection}{Visualizing a Circle in 3D}
\begin{examplebox}
