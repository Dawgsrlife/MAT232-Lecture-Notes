...
Welcome to MAT232! While the name suggests a deep dive into linear algebra, our journey begins in three-dimensional space, laying the foundation for vector geometry and beyond. 

\section*{Section 2.1/2.2: Welcome to 3D Space!}

\begin{remarkbox}
\textbf{Review of Cartesian Coordinates in Two Dimensions:} 
...
\begin{illustrationbox}
    \textbf{Self-note: Insert a 2D Cartesian plane illustration here.}
    \begin{figure}[H]
        \centering
...
\textbf{Extending to Three Dimensions:} 
...
\begin{illustrationbox}
    \textbf{Self-note: Insert a 3D Cartesian coordinate system illustration here.}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.35\textwidth]{sample_image.jpg}
