...
\subsection*{Preliminary Concepts: Conic Sections}
\addcontentsline{toc}{subsection}{Preliminary Concepts: Conic Sections}
...
\begin{definitionbox}
\textbf{Definition of an Ellipse:}  
An ellipse is the set of all points in a plane such that the sum of their distances to two fixed points (called the \textit{foci}) is constant.
\end{definitionbox}

\begin{intuitionbox}
\textbf{Key Intuition:}  
Imagine stretching a string between two fixed points \( F_1 \) and \( F_2 \) on a plane. The shape traced by keeping the string taut while moving a pencil around defines an ellipse.
\end{intuitionbox}

\begin{definitionbox}
\textbf{Standard Forms of an Ellipse:}
\begin{itemize}
    \item \textbf{Horizontal Major Axis:}  
    \[
    \frac{(x-h)^2}{a^2} + \frac{(y-k)^2}{b^2} = 1,
    \]
    where \( a > b \), \( (h, k) \) is the center, and \( c^2 = a^2 - b^2 \), with \( c \) as the distance from the center to the foci.
...
\begin{examplebox}
\textbf{Example: Verifying an Ellipse}  
...
\begin{definitionbox}
\textbf{Definition of a Parabola:}  
A parabola is the set of all points in a plane equidistant from a fixed point (the \textit{focus}) and a fixed line (the \textit{directrix}).
\end{definitionbox}
...
\begin{definitionbox}
\textbf{Standard Forms of a Parabola:}
\begin{itemize}
    \item \textbf{Horizontal Opening:}  
    \[
    (y-k)^2 = 4p(x-h),
    \]
    where \( (h, k) \) is the vertex, and \( p \) is the distance from the vertex to the focus.
    \item \textbf{Vertical Opening:}  
    \[
    (x-h)^2 = 4p(y-k).
    \]
\end{itemize}
...
\begin{examplebox}
\textbf{Example: Verifying a Parabola}  
Show that the equation  
\[
y^2 = 12x
\]
...
\begin{definitionbox}
\textbf{Definition of a Hyperbola:}  
A hyperbola is the set of all points in a plane such that the absolute difference of their distances to two fixed points (called the \textit{foci}) is constant.
\end{definitionbox}
...
\begin{definitionbox}
\textbf{Standard Forms of a Hyperbola:}
\begin{itemize}
...
\begin{examplebox}
\textbf{Example: Verifying a Hyperbola}  
Show that the equation  
\[
9x^2 - 16y^2 = 144
\]
