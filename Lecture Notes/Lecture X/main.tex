...
\backgroundsetup{
  ...
  contents={\includegraphics[width=1.5\paperwidth, height=1.5\paperheight, keepaspectratio]{ninym_ralei_leaf (watermarked by AlexanderTheMango)}} % Keeps aspect ratio and scales to fill the page
}
